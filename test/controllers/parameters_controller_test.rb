...
class ParametersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parameter" do
    assert_difference('Parameter.count') do
      post parameters_url, params: { parameter: { description: @parameter.description, int_value: @parameter.int_value, tag: @parameter.tag, text_value: @parameter.text_value } }
    end
  ...
  test "should update parameter" do
    patch parameter_url(@parameter), params: { parameter: { description: @parameter.description, int_value: @parameter.int_value, tag: @parameter.tag, text_value: @parameter.text_value } }

...
class VillagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create village" do
    assert_difference('Village.count') do
      post villages_url, params: { village: { cod: @village.cod, department_id: @village.department_id, municipality_id: @village.municipality_id, name: @village.name } }
    end
  ...
  test "should update village" do
    patch village_url(@village), params: { village: { cod: @village.cod, department_id: @village.department_id, municipality_id: @village.municipality_id, name: @village.name } }

...
class DealersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dealer" do
    assert_difference('Dealer.count') do
      post dealers_url, params: { dealer: { address: @dealer.address, comission: @dealer.comission, last_name: @dealer.last_name, name: @dealer.name, phone: @dealer.phone } }
    end
  ...
  test "should update dealer" do
    patch dealer_url(@dealer), params: { dealer: { address: @dealer.address, comission: @dealer.comission, last_name: @dealer.last_name, name: @dealer.name, phone: @dealer.phone } }

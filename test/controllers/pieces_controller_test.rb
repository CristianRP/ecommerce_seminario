...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post pieces_url, params: { piece: { amount_cod: @piece.amount_cod, delivery_id: @piece.delivery_id, number: @piece.number, type: @piece.type, weight: @piece.weight } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { amount_cod: @piece.amount_cod, delivery_id: @piece.delivery_id, number: @piece.number, type: @piece.type, weight: @piece.weight } }
